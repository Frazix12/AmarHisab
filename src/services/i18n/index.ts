...
export const translations = {
  en: {
    ...
    onboarding: {
      ...
      chooseThemeSubtitle: "You can change this anytime in Settings",
    ...
    alerts: {
      ...
      sampleDataAddFailed: "Failed to add sample data. Please try again.",
  ...
  //     expenses: "খরচ",
  //     groceries: "বাজার",
  //     emptyExpenses: "কোনো খরচ পাওয়া যায়নি",
  //     emptyGroceries: "কোনো বাজার আইটেম পাওয়া যায়নি",
  //     confirmAdd: "নিশ্চিত করে যোগ করুন",
  //     tryAgain: "আবার চেষ্টা করুন",
  //     noSpeechDetected: "কোনো বক্তব্য পাওয়া যায়নি",
  //     parseFailed: "ট্রান্সক্রিপ্ট পার্স করা যায়নি",
  //     micPermission: "মাইক্রোফোন পারমিশন প্রয়োজন",
  ...
  bn: {
    ...
    expenses: {
      ...
      expenseNotFound: "খরচ পাওয়া যায়নি",
      saveTransaction: "লেনদেন সংরক্ষণ করুন",
      expenseAddedOutsideToday:
        "খরচ যোগ হয়েছে। আজকের তালিকায় দেখাবে না, হিসাব পাতায় দেখুন।",
      expenseUpdatedOutsideToday:
        "খরচ আপডেট হয়েছে। আজকের তালিকায় দেখাবে না, হিসাব পাতায় দেখুন।",
    },
    ...
    statistics: {
      ...
      noPeriodData: "এই সময়ে কোনো খরচ নেই",
      noCategoryData: "এই ক্যাটাগরিতে কোনো খরচ নেই",
      startTracking: "ট্র্যাক শুরু করুন পরিসংখ্যান দেখতে",
      tryAnotherPeriod: "অন্য সময় বেছে নিন বা ফিল্টার রিসেট করুন",
    ...
    form: {
      ...
      edit: "এডিট",
      updateTemplate: "নতুন মান দিয়ে টেমপ্লেট আপডেট করুন",
      item: "জিনিস",
      date: "তারিখ",
    ...
    camera: {
      ...
      cameraUnavailableTitle: "ক্যামেরা পাওয়া যায়নি",
      cameraUnavailableMessage: "এই ফোনে কোনো ক্যামেরা ডিভাইস পাওয়া যায়নি।",
    },
    ...
    helpers: {
      ...
      templateInfo:
        "টেমপ্লেট ব্যবহার করলে বাজার দ্রুত যোগ করা যায়। পরে চাইলে এডিট বা মুছে ফেলতে পারবেন।",
    ...
    onboarding: {
      ...
      chooseLanguageSubtitle: "পরে পরিবর্তন করতে পারবেন",
      chooseTheme: "আপনার থিম বাছুন",
      chooseThemeSubtitle: "পরে পরিবর্তন করতে পারবেন",
    ...
    alerts: {
      ...
      sampleDataAddFailed: "নমুনা ডেটা যোগ করা যায়নি, আবার চেষ্টা করুন।",
      dataClearFailed: "ডেটা মুছতে পারিনি, আবার চেষ্টা করুন।",
